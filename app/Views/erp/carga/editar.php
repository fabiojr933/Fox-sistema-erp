                        ...
                        <div class="row mg-b-25">
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="form-control-label">Nome da carga operacional: <span class="tx-danger">*</span></label>
                                 <input class="form-control" type="text" name="carga" placeholder="Digite o nome." required>
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="form-control-label">% exemplo: 78.90% <span class="tx-danger">*</span></label>
                                 <input class="form-control" type="text" class="form-control" id="percentage-input">
                              </div>
                           </div>
