            ...
            <div class="card mb-4 shadow-1">
               <div class="card-header">
                  <h4 class="card-header-title">
                     Carga operacional cadastrados
                  </h4>
                  <div class="card-header-btn">
                     <a href="/erp/dashboard/carga/novo"><i class="ionicons ion-android-add-circle"></i> Novo</a>
                  </div>
               </div>
                        ...
                        <tbody>
                           <tr>
                              ...
                              <td class="text-right table-actions">
                                 <a class="table-action tx-gray-800 mg-r-10" href="/erp/dashboard/carga/editar/1"><i class="fa fa-pencil"></i></a>
