            ...
            <div class="card mb-4 shadow-1">
               <div class="card-header">
                  ...
                  <div class="card-header-btn">
                     <a href="/erp/dashboard/marca/novo"><i class="ionicons ion-android-add-circle"></i> Novo</a>
                  </div>
               </div>
                        ...
                        <tbody>
                           <tr>
                              ...
                              <td class="text-right table-actions">
                                 <a class="table-action tx-gray-800 mg-r-10" href="/erp/dashboard/marca/editar/1"><i class="fa fa-pencil"></i></a>
