                        ...
                        <div class="row mg-b-25">
                           <div class="col-md-12">
                              <div class="form-group">
                                 <label class="form-control-label">Nome da fabricante: <span class="tx-danger">*</span></label>
                                 <input class="form-control" type="text" name="marca" placeholder="Digite o nome." required>
                              </div>
                           </div>
                           <div class="col-md-12">
