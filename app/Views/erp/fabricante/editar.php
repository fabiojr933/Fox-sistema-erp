            ...
            <div class="card mb-4 shadow-1">
               <div class="card-header">
                  ...
                  <div class="card-header-btn">
                     <a href="/erp/dashboard/fabricante"><i class="ion-ios-arrow-back"></i> Voltar</a>
                  </div>
               </div>
                        ...
                        <div class="row mg-b-25">
                           <div class="col-md-12">
                              <div class="form-group">
                                 <label class="form-control-label">Nome do fabricante: <span class="tx-danger">*</span></label>
                                 <input class="form-control" type="text" name="fabricante" placeholder="Digite o nome." required>
                              </div>
                           </div>
                           <div class="col-md-12">
